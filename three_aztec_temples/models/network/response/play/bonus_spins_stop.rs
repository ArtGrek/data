...
use super::super::super::super::server::{ContextActionsEnum, SpinsBsVEnum, BonusspinsstopModesEnum, StatusCodeEnum, };
...
pub struct Spins {
	...
	pub bs_v: Vec<Vec<SpinsBsVEnum>> /* [[10.0,0,0],[0,0,0],[0,20,50.0],[0,0,0],[30.0,10.0,0]] */,
	pub bs_values: Vec<Vec<f64>> /* [[0.5,0,0],[0,0,0],[0,1,2.5],[0,0,0],[1.5,0.5,0]] */,
	pub lines: i64 /* 25 */,
...
pub struct BonusSpinsStop {
	...
	pub context: Context,
	pub modes: Vec<BonusspinsstopModesEnum> /* auto, freebet, play */,
