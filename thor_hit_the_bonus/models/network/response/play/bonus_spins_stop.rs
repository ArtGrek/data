...
use super::super::super::super::server::{ContextActionsEnum, BsTypeEnum, SpinsBsVEnum, SpinsSelectedModeEnum, BonusspinsstopModesEnum, StatusCodeEnum, UserNickEnum, };
...
pub struct Bs {
	...
	#[serde(rename = "type")]
	pub bs_type: BsTypeEnum /* collector, infinity, infinity_wrath, infinity_wrath_sticky, mystery, mystery_jp, regular */,
...
pub struct Spins {
	...
	pub bs_v: Vec<Vec<SpinsBsVEnum>> /* [[400,600,400,200,600],[200,200,1000,0,600],[0,0,400,400,200],[200,200,7000,0,0],[0,0,400,200,400]] */,
	...
	pub round_win: i64 /* 0 */,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub selected_mode: Option<SpinsSelectedModeEnum> /* 1, 2, 3 */,
...
pub struct Context {
	...
	pub last_action: String /* bonus_spins_stop */,
...
pub struct BonusSpinsStop {
	...
	pub context: Context,
	pub modes: Vec<BonusspinsstopModesEnum> /* auto, play */,
