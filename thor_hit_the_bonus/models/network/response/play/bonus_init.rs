...
use super::super::super::super::server::{ContextActionsEnum, BsTypeEnum, BonusBsVEnum, LastbsTypeEnum, BonusSelectedModeEnum, StickybsTypeEnum, BsTypeEnum, BsnewTypeEnum, BonusinitModesEnum, UserNickEnum, };
...
pub struct Bb {
	...
	pub thor_state: Option<i64> /* 1 */,
	pub thor_wrath_spins_left: i64 /* 0, 2, 3, 4 */,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub thor_wrath_symbol_pos: Option<Vec<i64>> /* [0,0], [0,1], [0,3], [0,4], [1,0], [1,1], [2,0], [2,1], [2,3], [2,4], [3,0], [3,3], [4,0], [4,3], [4,4] */,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub thor_wrath_total: Option<i64> /* 1200, 1400, 1600, 1800, 2000, 2200, 2400, 3000, 3200, 3800, 4200, 4600, 5000, 5200 */,
}
...
pub struct Bet20 {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub thor_wrath_symbol_pos: Option<Vec<i64>> /* [0,0], [0,1], [0,2], [0,4], [1,0], [1,1], [1,3], [1,4], [2,0], [2,1], [2,2], [2,3], [2,4], [3,0], [3,1], [3,3], [3,4], [4,0], [4,1], [4,3], [4,4] */,
	pub thor_wrath_total: i64 /* 0, 600, 800, 1000, 1600, 1800, 2000, 2200, 2400, 2600, 2800, 3000, 3200, 3400, 3600, 3800, 4000, 4200, 4600, 5000, 5200, 5800, 6800, 7600, 7800, 10200, 12600, 12800 */,
}
...
pub struct User {
	...
	pub balance_version: i64 /* 1752068008560 */,
...
pub struct BonusInit {
	...
	pub context: Context,
	pub modes: Vec<BonusinitModesEnum> /* auto, play */,
