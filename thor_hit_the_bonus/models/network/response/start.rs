...
use super::super::super::server::{ContextActionsEnum, BsTypeEnum, BonusBsVEnum, LastbsTypeEnum, BonusSelectedModeEnum, StickybsTypeEnum, ContextCurrentEnum, ContextLastActionEnum, BsnewTypeEnum, StartModesEnum, SymbolsTypeEnum, UserNickEnum, };
...
pub struct Bb {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub thor_wrath_symbol_pos: Option<Vec<i64>> /* [3,0] */,
	#[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Debug, Serialize, Deserialize, Default, Clone)]
pub struct Bet20 {
	pub thor_state: i64 /* 0, 1 */,
	pub thor_wrath_spins_left: i64 /* 0, 1 */,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub thor_wrath_symbol_pos: Option<Vec<i64>> /* [4,4] */,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub thor_wrath_total: Option<i64> /* 0, 4000 */,
}
...
pub struct Mysteries {
	...
	pub reel: i64 /* 0, 1, 2, 3, 4 */,
	#[serde(rename = "type")]
	pub mysteries_type: String /* regular */,
	pub value: i64 /* 200, 400, 600, 800, 2000 */,
}
...
impl From<server::Mysteries> for Mysteries {
	fn from(obj: server::Mysteries) -> Self {
		Mysteries {
			position: obj.position,
			reel: obj.reel,
			mysteries_type: obj.mysteries_type,
			value: obj.value,
		}
	}
}
...
pub struct StickyBs {
	...
	pub reel: i64 /* 0, 1, 2, 3, 4 */,
	#[serde(rename = "type")]
	pub sticky_bs_type: StickybsTypeEnum /* infinity, infinity_mystery, infinity_mystery_jp, infinity_wrath_sticky */,
	pub value: i64 /* 200, 400, 600, 800, 1000, 1200, 2000, 4000, 7000, 10000, 13800 */,
}
...
pub struct Bonus {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub new_bs: Option<Vec<LastBs>>,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub new_collectors: Option<Vec<Mysteries>>,
	#[serde(skip_serializing_if = "Option::is_none")]
...
pub struct BsNew {
	...
	pub value: i64 /* 0, 200, 400, 600, 800, 1000, 1200, 1400, 1600, 1800, 2000, 2600, 3400, 4000, 4800, 5000, 10000 */,
}
...
#[derive(Debug, Serialize, Deserialize, Default, Clone)]
pub struct Start {
	pub command: String /* start */,
	pub context: Context,
	pub modes: Vec<StartModesEnum> /* auto, play */,
