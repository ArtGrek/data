...
use super::super::super::server::{LoginModesEnum, StatusCodeEnum, };

#[derive(Debug, Serialize, Deserialize, Default, Clone)]
pub struct Status {
	pub code: StatusCodeEnum /* OK, OTHER_ERROR */,
	#[serde(skip_serializing_if = "Option::is_none")]
	pub traceback: Option<String> /* crit (0) PlayerGUID is empty on connect [parsePlayerGUID(/opt/source/server/modules/common_server/cm/TCmConnect.cpp:452)] */,
